...
{
    public record CreateProductCommand(string Name, string CompanyName, string Size, List<string> Category, string Description, int StockingQuantity, string ImagePath, decimal CostPrice, decimal SellingPrice, DateOnly ExpiryDate)
